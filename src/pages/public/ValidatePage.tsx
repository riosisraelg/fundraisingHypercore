    ...
    return (
      <main className="validate-page">
        <div className="validate-container search">
          ...
          <Link to="/" className="btn-ghost" style={{ marginTop: "1.5rem" }}>
            Regresar al Sorteo
          </Link>
        </div>
      </main>
      ...
      <main className="validate-page">
        <div className="validate-container error">
          ...
          <div className="error-actions">
            <Link to="/validate" className="btn-primary">Intentar de Nuevo</Link>
      ...
      <main className="validate-page">
        <div className={`validate-container ${isActive ? "active" : "cancelled"}`}>
          <div className="status-badge">
            {isActive ? (
              <><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg> BOLETO VALIDO</>
            ) : (
              <><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg> BOLETO CANCELADO</>
            )}
          </div>
          ...
          <div className="result-actions">
            <Link to="/validate" className="btn-primary">Validar Otro Boleto</Link>
            <Link to="/" className="btn-ghost">Regresar al Sorteo</Link>
          </div>
        </div>
      </main>
    );
